...
- **Funding arb history:** settled Binance/Bybit prints in a date range, grouped into long/short stretches that beat round-trip fees (`GET /api/v1/market/funding-arb/history`, MCP `get_funding_arb_history`, Telegram `/fundingarb hist`)
