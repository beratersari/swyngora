...
import { MarketsFilterForm } from '@/components/organisms/MarketsFilterForm';
      ...
      footer={
        <View style={styles.footer}>
          <View style={styles.footerBtn}>
            <Button label="Cancel" variant="secondary" onPress={vm.onCancel} />
          </View>
          <View style={styles.footerBtn}>
            <Button label="Apply" onPress={vm.onApply} />
          </View>
        </View>
      }
    >
