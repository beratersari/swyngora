...
| `estimate_liquidation_hunt` | Hypothetical per-venue hunt: spot size to reach liq zones + desk result + up/down ease scores and cascade paths (zones one by one, hop strength, where self-fueling stalls) |
