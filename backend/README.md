...
| `GET` | `/api/v1/market/cvd` | Cumulative buy−sell (CVD) versus price; 15m/1h/4h/24h change; overlap combined with venue share/split and price/CVD divergence duration |
