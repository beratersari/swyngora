...
| Layer | Package | Tests |
|---|---|---|
| Domain | `internal/domain` | `candle_test.go`, `errors_test.go`, `ports_test.go`, `ticker_test.go`, `supply_test.go`, `open_interest_test.go`, `volume_profile_test.go` |
| Application | `internal/service/market` | `service_test.go`, `volumeprofile_test.go` (fakes for ports) |
