...
- `GET /api/v1/market/around/similar` past important-move setups like the current tape; unique events; pre-move tape only (`dataFrom`/`dataTo`); afterHorizons 15m/1h/4h. See [`around.md`](around.md).
