...
- `GET /api/v1/market/around/similar` past important-move setups like the current tape; unique events by overlapping price-move range; pre-move tape only; caller-picked `horizons`. See [`around.md`](around.md).
