...
- `GET /api/v1/market/liquidation-hunt/heatmap` price × time liquidation intensity (12h/24h/3d/7d; Binance, Bybit, combined). See [`liquidation-hunt.md`](liquidation-hunt.md).
