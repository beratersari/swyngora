...
- `GET /api/v1/market/around/similar` past important-move setups like the current tape; overlapping/same-move hits are one event; afterHorizons 15m/1h/4h (up/down, avg, median, unique events). See [`around.md`](around.md).
