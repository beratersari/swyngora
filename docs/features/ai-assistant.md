...
Market specialist tools mirror Go MCP (ticker, **FX rates** `get_fx_rates`, **spot order book** / **order-book analysis** / **market-wide book** / **market impact** / **order heatmap**, **order-book alerts**, candles, indicators, **RSI heatmap** `get_rsi_heatmap`, pumps, paper portfolio, scanner, **watchlist sharing**, **API keys**).  
