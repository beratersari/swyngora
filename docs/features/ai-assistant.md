...
Market specialist tools mirror Go MCP (ticker, **spot order book** / **order-book analysis** / **market-wide book**, **order-book alerts**, candles, indicators, pumps, paper portfolio, scanner, **watchlist sharing**, **API keys**).  
